<el-dialog>
    <dialog id="modalDelete-{{ $row->idkategori_klinis }}"
        ...
        <div class="fixed inset-0 z-[9500] flex items-center justify-center p-4">
            ...
            <el-dialog-panel class="bg-white rounded-xl shadow-2xl w-full max-w-sm p-6 transform transition-all">
                ...
                <p class="text-gray-600 text-sm mb-6">
                    Apakah kamu yakin ingin menghapus kategori klinis
                    <span class="font-semibold text-gray-800">"{{ $row->nama_kategori_klinis }}"</span>?
                ...
                <div class="flex justify-end gap-2">
                    ...
                    <form action="{{ route('Admin.KategoriKlinis.delete-kategori-klinis', $row->idkategori_klinis) }}" method="POST">
                        @csrf
                        @method('DELETE')
                        <button type="submit"
