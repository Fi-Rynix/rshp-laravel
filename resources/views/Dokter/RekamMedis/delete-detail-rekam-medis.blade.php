...
<el-dialog>
    <dialog id="modalDelete" class="fixed inset-0 z-[9000] bg-transparent backdrop:bg-transparent">
        ...
        <div class="fixed inset-0 z-[9500] flex items-center justify-center p-4">
            ...
            <el-dialog-panel
                ...
                <p class="text-gray-600 text-sm mb-6">
                    Apakah kamu yakin ingin menghapus tindakan ini?
                ...
                <div class="flex justify-end gap-2">
                    ...
                    {{-- HAPUS --}}
                    <form action="{{ route('Dokter.RekamMedis.delete-detail', $detail->iddetail_rekam_medis) }}" method="POST" style="display: inline;">
                        @csrf
                        @method('DELETE')
